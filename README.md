...
```
cd existing_repo
git remote add origin https://gitlab.com/flutterninjaz/havchatapp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/flutterninjaz/havchatapp/-/settings/integrations)
